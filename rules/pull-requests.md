...
1. Check `.github/PULL_REQUEST_TEMPLATE.md` if exists
2. Study user's previous PRs in the repo (`gh pr list --author @me`)
3. **Show PR preview ALWAYS** — display title and body, ask for confirmation before submitting
